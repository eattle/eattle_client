...
//        mListener = null;
    ...
    void selectCard(String thumbNailID, String storyName, int folderID, int pictureNum){
        ...
        if(pictureNum > CONSTANT.BOUNDARY){
            ...
            ((SmallStoryCard)card).setTitleImage(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/" + "thumbnail" + "/" + db.getMediaById(Integer.parseInt(thumbNailID)).getName());
