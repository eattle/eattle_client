    ...
    void selectCard(String thumbNailID, String storyName, int folderID, int pictureNum){
        ...
        if(pictureNum <= CONSTANT.BOUNDARY){
            ...
            for(int i = 0; i < pictureNum; i++){
                ...
                card.setTag(data);
                ((DailyCard)card).setDailyImage(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/" + "thumbnail" + "/" + dailyMedia.get(i).getName());
...
//            }
            ...
            ((BigStoryCard)card).setTitleImage(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/" + "thumbnail" + "/" + db.getMediaById(Integer.parseInt(thumbNailID)).getName());
            ...
            data = new CardData(CONSTANT.TOPHOKET, randomMedia.getId());
            card.setTag(data);
            ((ToPhoketCard)card).setImage(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/" + "thumbnail" + "/" + randomMedia.getName());
            mListView.add(card);
