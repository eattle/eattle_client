...
//    private static final String KEY_PICNAME = "picname";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('Dormitory150', 40.418776, -86.925172,'1.2.3.4.5',0,0,'spot1');" );
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('Burton Morgan',40.423646, -86.922908,'6.7.8.9.10',0,0,'spot2');" );
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('DLR',40.421226,-86.922258,'11.12.13.14.15',0,0,'spot3');" );
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('PMU',40.425588,-86.91081,'16.17.18.19.20',0,0,'spot4');" );
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('Knoy Hall',40.427661,-86.9111284,'21.22.23.24.25',0,0,'spot5');" );
            db.execSQL( "insert into spot (name, latitude, longitude, spotInfoID, spotGroupID, productID, picName) values ('Research Park',40.4614305,-86.9308978,'26.27.28.29.30',0,0,'spot6');" );
